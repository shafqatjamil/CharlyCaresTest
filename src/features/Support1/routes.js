...
import Support1Home from './Home/Desktop';
...
export const LoadableSupportHome = Loadable({
  loader: () => {
    if (isMobile) {
      return import(/* webpackChunkName: "support-home" */ './Home');
    } else {
      return import(/* webpackChunkName: "support-home" */ './Home/Desktop');
    }
  },
  loading: () => {
    return <Loader isLoading />;
...
export const LoadableSend = Loadable({
  loader: () => {
    if (isMobile) {
      return import(/* webpackChunkName: "booking-send" */ './Home/Desktop');
    } else {
      return import(/* webpackChunkName: "booking-send" */ './Home/Desktop');
    }
  },
